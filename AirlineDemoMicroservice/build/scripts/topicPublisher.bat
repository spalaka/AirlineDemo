...
set CLASSPATH=%APP_HOME%\lib\solace-samples-jms.jar;%APP_HOME%\lib\sol-jms-10.5.0.jar;%APP_HOME%\lib\fscontext-4.6-b01.jar;%APP_HOME%\lib\json-20090211.jar;%APP_HOME%\lib\commons-logging-1.1.3.jar;%APP_HOME%\lib\commons-lang-2.6.jar;%APP_HOME%\lib\org.osgi.annotation-6.0.0.jar;%APP_HOME%\lib\org.apache.servicemix.bundles.jzlib-1.0.7_2.jar;%APP_HOME%\lib\geronimo-jms_1.1_spec-1.1.1.jar
